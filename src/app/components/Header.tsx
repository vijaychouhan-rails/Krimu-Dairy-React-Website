        ...
        <div className="flex items-center justify-between py-4">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <Image
              ...
              width={80}
              height={80}
              className="bg-gradient-to-r from-primary to-accent w-20  rounded-lg flex items-center justify-center text-white font-bold text-xl"
            />
          </Link>
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                ...
                <div className="flex flex-col gap-6 mt-6">
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <SheetClose asChild>
                      <Link href="/" className="flex items-center space-x-2 py-2 hover:text-primary">
                        <span className="text-sm">Home</span>
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link href="/products" className="flex items-center space-x-2 py-2 hover:text-primary">
                        <span className="text-sm">Products</span>
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link href="/orders" className="flex items-center space-x-2 py-2 hover:text-primary">
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    {isLoggedIn ? (
                      ...
                      <SheetClose asChild>
                        <Link href="/login">
                          <Button variant="ghost" size="sm" className="justify-start px-0 w-full hover:bg-transparent">
                  ...
                  {location && (
                    <div className="flex flex-col space-y-3">
                      ...
                      <div className="flex items-start gap-2 py-2 bg-muted/50 p-3 rounded-lg">
                        <MapPin className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-foreground line-clamp-2">{location}</p>
                          <SheetClose asChild>
                            <button
                              onClick={handleChangeLocation}
